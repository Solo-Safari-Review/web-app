<!-- wide sidebar -->
<div id="wide-sidebar" class="fixed top-0 left-0 z-50 w-[296px] h-screen no-scrollbar scroll-smooth px-4 py-12 transition-transform -translate-x-full bg-[#1E1E1E] flex flex-col gap-12" tabindex="-1" aria-labelledby="wide-sidebar-label">
