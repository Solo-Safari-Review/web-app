<div class="hidden xl:flex">
    <form action="{{ route('categorized-reviews.show', $department) }}" method="GET" class="flex flex-col gap-6 py-4 px-4 border-l rounded-2xl h-fit w-[200px] text-center text-sm">
        @if ($category)
