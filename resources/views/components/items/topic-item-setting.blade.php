<div class="flex xl:flex-row flex-col gap-8 px-2 py-4 items-end xl:items-center justify-between w-full border-b border-[#535151]/30 has-checked:bg-[#E9D9C7]/30">
    ...
    <span class="hidden xl:block">{{ $reviewsCount }} Ulasan</span>
    <x-buttons.action-button id="{{ \App\Helpers\HashidsHelper::encode($topic->id) }}" show-url="{{ $showUrl }}" delete-url="{{ $deleteUrl }}" type="{{ $type }}"></x-buttons.action-button>
</div>
