<div class="hidden" id="confirmDelete">
    <div class="z-50 flex flex-col min-w-[350px] max-w-[600px] max-h-[400px] mx-auto gap-6 px-8 xl:px-[72px] py-16 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#D9D9D9] rounded-2xl items-center align-top">
        ...
        <div class="w-full flex flex-col gap-8 text-center">
            ...
            <div class="flex justify-between">
                <button type="button" class="button bg-[#2C2C2C] px-4 py-2 rounded-lg text-white hover:bg-[#2C2C2C]/80" onclick="$('#confirmDelete').hide()">Batalkan</button>
                <button type="submit" id="deleteButton" class="bg-[#4E1F00] px-4 py-2 rounded-lg text-white hover:bg-[#4E1F00]/80">Hapus</button>
            </div>
        </div>
    </div>
</div>
